...
the [protocol specification](https://github.com/adalinxx/Lattice/blob/18.0.0/docs/spec.md)
and [work and fork-choice rationale](https://github.com/adalinxx/Lattice/blob/18.0.0/docs/consensus-fork-choice.md).
