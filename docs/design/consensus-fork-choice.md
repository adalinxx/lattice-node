...
the [protocol specification](https://github.com/adalinxx/Lattice/blob/26.0.1/docs/spec.md)
and [work and fork-choice rationale](https://github.com/adalinxx/Lattice/blob/26.0.1/docs/consensus-fork-choice.md).
