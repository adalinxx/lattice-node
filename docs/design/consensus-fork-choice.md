...
the [protocol specification](https://github.com/adalinxx/Lattice/blob/20.0.7/docs/spec.md)
and [work and fork-choice rationale](https://github.com/adalinxx/Lattice/blob/20.0.7/docs/consensus-fork-choice.md).
