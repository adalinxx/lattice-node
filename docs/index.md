...
[philosophy](https://github.com/adalinxx/Lattice/blob/34.0.0/docs/philosophy.md)
and [foundational architecture](https://github.com/adalinxx/Lattice/blob/34.0.0/docs/foundational-architecture.md).
...
| I want to… | Read |
|---|---|
| Understand what Lattice is and why it exists | [Lattice philosophy](https://github.com/adalinxx/Lattice/blob/34.0.0/docs/philosophy.md) · [README](../README.md) |
...
| Understand the protocol in depth | [Lattice specification](https://github.com/adalinxx/Lattice/blob/34.0.0/docs/spec.md) · [Node boundary](protocol.md) |
...
- **[Lattice specification](https://github.com/adalinxx/Lattice/blob/34.0.0/docs/spec.md)** — the normative protocol and consensus rules.
